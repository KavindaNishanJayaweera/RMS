                    ...
                    <div class="row">
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                @if(Session::has('success')) <div class="alert alert-success mt-2 mb-2"><?php echo Session::get('success') ?></li></div>@endif
                                @if(Session::has('fail')) <div class="alert alert-danger mt-2 mb-2"><?php echo Session::get('fail') ?></li></div>@endif
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                <a href="{{ url('forgot-password') }}" class="text-muted font-13"><i class="dripicons-lock"></i> Forgot password?</a>
                                            </div><!--end col-->
                                        </div>
                                    ...
                                    <div class="m-3 text-center text-muted">
                                        <p class="mb-0">Don't have an account ?  <a href="{{ url('register') }}" class="text-primary ms-2">Register</a></p>
                                    </div>
