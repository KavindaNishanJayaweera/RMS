                            ...
                            <div class="card">
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold text-white font-18">Oops !</h4>

                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="ex-page-content text-center">
                                        <img src="{{ asset('assets/images/fail.png') }}" alt="0" class="" height="170">
                                        <h1 class="mt-5 mb-4" style="font-size: 55px;color:#CD1818;">Fail</h1>
                                        <h5 class="font-16 text-muted mb-5">{{$message}}</h5>
                                    </div>
                                    <a class="btn btn-primary w-100" href="{{url('dashboard')}}">Back to Dashboard <i class="fas fa-redo ml-1"></i></a>
                                </div><!--end card-body-->
