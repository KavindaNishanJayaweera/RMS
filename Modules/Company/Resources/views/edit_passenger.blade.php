                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" value="{{$other_details->royalty_deduction}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="royalty_deduction">
                                        @if($errors->has("royalty_deduction")) <div class="alert alert-danger mt-2">{{ $errors->first('royalty_deduction') }}</li></div>@endif
                                    </div>
