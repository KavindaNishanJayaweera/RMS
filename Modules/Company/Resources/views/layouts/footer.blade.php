 <!--Start Rightbar-->
        ...
        <!-- App js -->
        <script src="{{ asset('assets/plugins/splide/splide.min.js') }}"></script>
        <script src="{{ asset('assets/pages/splide.init.js') }}"></script>
...
<!-- Mirrored from mannatthemes.com/unikit/default/ecommerce-index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 03:37:32 GMT -->
</html>
